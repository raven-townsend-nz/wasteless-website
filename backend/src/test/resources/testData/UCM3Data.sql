...
VALUES  (2, 'A City', 'Canada', '70001', 'Louisiana', 'Paul Wayne Haggerty Road', '2176', 'A Suburb'),
        (3, 'B City', 'Russia', '38117', 'Tennessee', 'Burton Avenue', '3231', 'B Suburb'),
        (4, 'C City', 'Italy', '70001', 'Louisiana', 'Paul Wayne Haggerty Road', '2176', 'C Suburb'),
        (5, 'D City', 'Malaysia', '70001', 'Louisiana', 'Paul Wayne Haggerty Road', '2176', 'D Suburb'),
        (6, 'E City', 'Brazil', '56310-320', 'Pernambuco', 'Rua Planalto', '560', 'E Suburb'),
...
VALUES (2, 'David', 'adama', 'Enyang', 'DAE', 'Definitely a real person', 'test@test.com', '2001-01-01', '0800 838383',
       ...
       (9, 'John', 'Hector', 'Smith', '', '', 'johnsmith99@gmail.com', sysdate() - interval 10 year, '', 9, '1337-H%nt3r2', 'user', sysdate());

INSERT INTO MARKETPLACE_CARD(MARKETPLACE_CARD_ID, CREATOR_ID, SECTION, CREATED, DISPLAY_PERIOD_END, TITLE, DESCRIPTION,
                             NOTIFIED_EXPIRING)
VALUES
(1, 7, 'ForSale', '2019-01-01', sysdate(), '!', '', false),
(2, 3, 'ForSale', '2001-01-03', sysdate(), '1', '', false),
